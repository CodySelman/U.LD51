...
namespace CodTools.StsMap
{
    public static class MapGenerator
    {
        ...
        public static Map GetMap(MapConfig conf)
        {
            ...
            var bossNodeName = RandomUtils.GetRandomItem<NodeBlueprint>(
                config.nodeBlueprints
        ...
        private static void PlaceLayer(int layerIndex)
        {
            ...
            for (var i = 0; i < config.GridWidth; i++)
            {
                ...
                var blueprintName = RandomUtils.GetRandomItem<NodeBlueprint>(
                    config.nodeBlueprints
        ...
        private static void GeneratePaths()
        {
            ...
            candidateXs = RandomUtils.Shuffle<int>(candidateXs);
